...
let allEarthquakespast24hours = new L.LayerGroup();
...
let overlays = {
  ...
  "Earthquakespast24hours": allEarthquakespast24hours
};
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/AnaGajardoni/Mapping_Earthquakes/main/PB2002_boundaries.json").then(function (data) {
    L.geoJson(data, { style: { color: "brown", weight: 1.5 } }).addTo(allTectonicPlates);
    console.log(data);
  });
...
// 4. Use the same style as the earthquake data.
  ...
  d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_day.geojson").then(function(data) {
    ...
    // 4. Use the same style as the earthquake data.
      ...
      }).addTo(allEarthquakespast24hours);
    
      // 8. Add the major earthquakes layer to the map.
      allEarthquakespast24hours.addTo(map);
